...
import Project4 from './styled_components/images/Project4.png'
...
background-size: cover;
`
const ImgDiv5 = ImgDiv1.extend`
background: linear-gradient(0deg, rgba(0,63,145,0.8),rgba(0,63,145,0.8)), url(${Project4}) center no-repeat;
background-size: cover;
`
                ...
                <ScrollContainer>
                    ...
                    Supriya Yerramilli <a href="https://supriyayerramilli.com">(Portfolio here)</a>, and Eric Lu <a href="https://www.ericlu.site">(Portfolio here)</a>. My responsibilities included building React components and styling.
                        ...
                        <ContentDivThree>
                            ...
                            <Overlay href="https://tome-dm.herokuapp.com/">
                                <p>Tome is my final project and very much still a work in progress. This is a follow up to my second project Dungeon Master. This app was designed to make the lives of Dungeon Masters running a game of Dungeons and Dragons easier. From Tome, a Dungeon Master is able to run, create and edit a full Dungeons and Dragons adventure and look up rules, spells, and monsters using a third-party API. Whereas this is not fully complete, the functionality of running a campaign is available.
                    </p>
                            </Overlay>
                        </ContentDivThree>
                    </ContainerThreeWrap>
